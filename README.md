...
- Generate `admin` user `password` [here](https://www.web2generators.com/apache-tools/htpasswd-generator){:target="_blank"}. You need both passwords decrypt and encrypted
...
```
- Customize the file `docker-compose.override.yml` if you use [trafik](https://traefik.io/){:target="_blank"}
